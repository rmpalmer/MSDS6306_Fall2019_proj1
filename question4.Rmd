...
# plot
abv_df %>% ggplot(aes(x=State,y=median_abv)) + geom_col(color="#13294b",fill="#C8102E") + ggtitle('Median ABV by state')
...
# plot
ibu_df %>% ggplot(aes(x=State,y=median_ibu)) + geom_col(color="#13294b",fill="#C8102E") + ggtitle('Median IBU by state')
