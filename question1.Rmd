...
plot_usmap(regions = c("states"), data = breweries_by_state_tomap,
  ...
  label_color = "black") +
  scale_fill_continuous(name = "n", low="ivory", high="red2") +
...
plot_usmap(regions = c("states"), data = breweries_by_state_tomap,
  ...
  label_color = "black") +
  scale_fill_continuous(name = "n*", low="ivory", high="navyblue") +
  theme(legend.position="right", 
        plot.caption = element_text(color="navyblue", size = 9, hjust=1)) +
