...
ipa_percent <- as.integer(100 * ipa_count / total_count)
other_percent <- as.integer(100 * other_count / total_count)
```

Out of a total of `r total_count` beers, `r ipa_count` (`r ipa_percent`)
are IPA and `r other_count` (`r other_percent`) are other ales.
