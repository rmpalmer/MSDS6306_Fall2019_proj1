...
The accuracy turns out to be `r always_acc` %.

The sensitivity is `r always_sens` %.

The specificity is `r always_spec` %.
...
The random guess model has accuracy of `r mean_accuracy` %.

Its sensitivity is `r mean_sensitivity` %.

Its specificity is `r mean_specificity` %.
...
accuracy of `r mean_accuracy` %

sensitivity of `r mean_sensitivity` %

specificity of `r mean_specificity` %
